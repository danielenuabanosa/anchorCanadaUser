...
export const ANCHOR_FIELD_OPT_OUT = 'no-anchor-field';
export const ANCHOR_TEXTAREA = 'anchor-textarea';
export const ANCHOR_SELECT = 'anchor-select';
export const ANCHOR_LABEL = 'anchor-label';
export const ANCHOR_LABEL_REQUIRED = 'anchor-label-required';
