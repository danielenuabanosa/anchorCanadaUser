...
export function Footer({ variant = 'desktop', className }: FooterProps) {
  const message = 'Your organization details can be updated anytime in your account settings.';
  ...
  return (
    <div className={cn('mx-auto mt-5 w-full max-w-[1548px] rounded-[10px] bg-[#EFF4FF] p-5', className)}>
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <Link
          href="/privacy"
          className="inline-flex items-center gap-3 type-button text-[#2F66C8] transition-opacity hover:opacity-75"
        >
          Learn more about our Privacy Policy
